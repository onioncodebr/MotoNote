      ...
      <div className="panel bg-[var(--dash-surface)] border border-[var(--dash-border)] rounded-[var(--radius-md)] p-[var(--space-5)] min-w-0 shadow-[var(--shadow-sm)] transition-[background,border-color,box-shadow] duration-200 hover:shadow-[var(--shadow-md)]">
        <div className="table-scroll" role="table" aria-label="Motoboys">
          ...
          {isLoading ? (
            ...
            <div className="empty-state flex flex-col items-center gap-[10px] py-[44px] px-5 text-center text-[length:var(--fs-base)] text-[var(--dash-text-faint)]"><Bike size={22} />{buscaAplicada ? 'Nenhum motoboy encontrado com esse nome.' : 'Nenhum motoboy cadastrado.'}</div>
          )}
        </div>
