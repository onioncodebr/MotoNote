...
public class ValeController {
    ...
    // GET /api/vales?startDate=2026-07-01&endDate=2026-07-31&motoboyId=(opcional)&page=&size=
    @GetMapping
    public ResponseEntity<PageResponseDTO<ValeResponseDTO>> findAll(
            ...
            Authentication auth) {
        return ResponseEntity.ok(valeService.findAllByUserPaged(startDate, endDate, motoboyId, auth, page, size));
    }
