...
import br.com.onioncode.motonote.dto.ClienteRankingResponseDTO;
import br.com.onioncode.motonote.dto.ClienteRequestDTO;
import br.com.onioncode.motonote.dto.ClienteResponseDTO;
...
public class ClienteService {
    ...
    // retorna todos do tenant. ILIKE (Postgres) não interpreta regex, então,
    // diferente do antigo $regex do Mongo, o termo vai direto pra query sem
    // precisar de nenhum escaping (mesmo raciocínio de UsuarioService).
    private List<Cliente> buscarClientesDoTenant(String termo, String usuarioId) {
        ...
        return clienteRepo.findByNomeOuTelefoneContainingAndUsuarioId(termo, usuarioId);
    }
    ...
    private List<Entrega> buscarEntregasComCliente(List<String> motoboyIds, LocalDate startDate, LocalDate endDate) {
        ...
        if (startDate != null && endDate != null) {
            ...
            entregas = entregaRepo.findByMotoboyIdInAndLocalDateGreaterThanEqualAndLocalDateLessThan(
