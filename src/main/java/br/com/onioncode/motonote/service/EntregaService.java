...
import br.com.onioncode.motonote.exception.ClienteNotFoundException;
import br.com.onioncode.motonote.exception.DadosClienteObrigatoriosException;
import br.com.onioncode.motonote.exception.EntregaNaoPendenteException;
import br.com.onioncode.motonote.exception.EntregaNotFoundException;
...
import br.com.onioncode.motonote.exception.ObservacaoObrigatoriaException;
import br.com.onioncode.motonote.exception.ValorPedidoMenorQueEntregaException;
import br.com.onioncode.motonote.exception.ValorPedidoObrigatorioException;
...
public class EntregaService {
    ...
    public List<EntregaResponseDTO> findByMotoboyAndDateRangeSelf(String motoboyId, LocalDate startDate, LocalDate endDate) {
        ...
        List<Entrega> entregas = entregaRepo.findByMotoboyIdAndLocalDateGreaterThanEqualAndLocalDateLessThan(
    ...
    public PageResponseDTO<EntregaResponseDTO> findByMotoboyAndDateRangeSelfPaged(String motoboyId, LocalDate startDate, LocalDate endDate, int page, int size) {
        validarIntervalo(startDate, endDate);
        Page<Entrega> resultado = entregaRepo.findByMotoboyIdAndLocalDateGreaterThanEqualAndLocalDateLessThan(
                motoboyId, startDate, endDate.plusDays(1), pageableDescPorData(page, size));
        return PageResponseDTO.from(resultado.map(this::entregaToResponse));
    }
    ...
    public List<EntregaResponseDTO> findByMotoboyAndDate(String motoboyId, LocalDate date, Authentication authentication) {
        ...
        List<Entrega> entregas = entregaRepo.findByMotoboyIdAndLocalDate(motoboyId, date);
    ...
    public List<EntregaResponseDTO> findAllByUserAndDate(LocalDate date, Authentication authentication) {
        ...
        List<Entrega> entregas = entregaRepo.findByMotoboyIdInAndLocalDate(motoboyIds, date);
    ...
    public List<EntregaResponseDTO> findAllByUserAndDateRange(LocalDate startDate, LocalDate endDate, Authentication auth) {
        ...
        List<Entrega> entregas = entregaRepo.findByMotoboyIdInAndLocalDateGreaterThanEqualAndLocalDateLessThan(
    ...
    public PageResponseDTO<EntregaResponseDTO> findReportPaged(LocalDate startDate, LocalDate endDate, String motoboyId, Authentication auth, int page, int size) {
        ...
        Page<Entrega> resultado = entregaRepo.findByMotoboyIdInAndLocalDateGreaterThanEqualAndLocalDateLessThan(
    ...
    public PageResponseDTO<EntregaResponseDTO> findPendentes(LocalDate startDate, LocalDate endDate, String motoboyId, Authentication auth, int page, int size) {
        ...
        if (motoboyId != null && !motoboyId.isBlank()) {
            motoboyRepo.findByIdAndUsuarioId(motoboyId, user.getId())
                    .orElseThrow(MotoboyNotFoundException::new);
            Page<Entrega> resultado = entregaRepo.findPendentesByMotoboyIdAndLocalDateBetween(
                    motoboyId, startDate, endDate.plusDays(1), pageable);
            return PageResponseDTO.from(resultado.map(this::entregaToResponse));
        }
        ...
        Page<Entrega> resultado = entregaRepo.findPendentesByMotoboyIdInAndLocalDateBetween(
                motoboyIds, startDate, endDate.plusDays(1), pageable);
        return PageResponseDTO.from(resultado.map(this::entregaToResponse));
    }
    ...
    public ResumoFaturamentoDTO getResumoPendentes(LocalDate startDate, LocalDate endDate, String motoboyId, Authentication auth) {
        ...
        if (motoboyId != null && !motoboyId.isBlank()) {
            motoboyRepo.findByIdAndUsuarioId(motoboyId, user.getId())
                    .orElseThrow(MotoboyNotFoundException::new);
            pendentes = entregaRepo.findPendentesByMotoboyIdAndLocalDateBetween(
                    motoboyId, startDate, endDate.plusDays(1));
        } else {
            List<String> motoboyIds = motoboyRepo.findByUsuarioId(user.getId()).stream()
                    .map(Motoboy::getId)
            ...
            pendentes = motoboyIds.isEmpty()
                    ? new ArrayList<>()
                    : entregaRepo.findPendentesByMotoboyIdInAndLocalDateBetween(
                            motoboyIds, startDate, endDate.plusDays(1));
        }
    ...
    public PageResponseDTO<EntregaResponseDTO> findPorStatusLogistico(StatusLogisticoEntrega status, LocalDate startDate, LocalDate endDate,
        ...
        if (motoboyId != null && !motoboyId.isBlank()) {
            motoboyRepo.findByIdAndUsuarioId(motoboyId, user.getId())
                    .orElseThrow(MotoboyNotFoundException::new);
            Page<Entrega> resultado = entregaRepo.findByMotoboyIdAndStatusLogisticoAndLocalDateGreaterThanEqualAndLocalDateLessThan(
        ...
        Page<Entrega> resultado = entregaRepo.findByMotoboyIdInAndStatusLogisticoAndLocalDateGreaterThanEqualAndLocalDateLessThan(
    ...
    public ContagemStatusLogisticoDTO getContagemPorStatusLogistico(LocalDate startDate, LocalDate endDate, String motoboyId, Authentication auth) {
        ...
        if (motoboyId != null && !motoboyId.isBlank()) {
            motoboyRepo.findByIdAndUsuarioId(motoboyId, user.getId())
                    .orElseThrow(MotoboyNotFoundException::new);
            entregas = entregaRepo.findByMotoboyIdAndLocalDateGreaterThanEqualAndLocalDateLessThan(
                    motoboyId, startDate, endDate.plusDays(1));
        } else {
            List<String> motoboyIds = motoboyRepo.findByUsuarioId(user.getId()).stream()
                    .map(Motoboy::getId)
            ...
            entregas = motoboyIds.isEmpty()
                    ? List.of()
                    : entregaRepo.findByMotoboyIdInAndLocalDateGreaterThanEqualAndLocalDateLessThan(
                            motoboyIds, startDate, endDate.plusDays(1));
        }
