...
import br.com.onioncode.motonote.dto.GastoRequestDTO;
...
import br.com.onioncode.motonote.exception.GastoNotFoundException;
...
public class GastoService {
    ...
    public ResumoValorDTO getResumoMotoboySelf(String motoboyId, LocalDate startDate, LocalDate endDate) {
        ...
        List<Gasto> gastos = gastoRepo.findByMotoboyIdAndLocalDateGreaterThanEqualAndLocalDateLessThan(
    ...
    public PageResponseDTO<GastoResponseDTO> findAllByUserPaged(LocalDate startDate, LocalDate endDate, String motoboyId, Authentication auth, int page, int size) {
        ...
        if (motoboyId != null && !motoboyId.isBlank()) {
            ...
            Page<Gasto> resultado = gastoRepo.findByMotoboyIdAndLocalDateGreaterThanEqualAndLocalDateLessThan(
        ...
        Page<Gasto> resultado = gastoRepo.findByMotoboyIdInAndLocalDateGreaterThanEqualAndLocalDateLessThan(
    ...
    public ResumoValorDTO getResumo(LocalDate startDate, LocalDate endDate, String motoboyId, Authentication auth) {
        ...
        if (motoboyId != null && !motoboyId.isBlank()) {
            motoboyRepo.findByIdAndUsuarioId(motoboyId, user.getId())
                    .orElseThrow(MotoboyNotFoundException::new);
            gastos = gastoRepo.findByMotoboyIdAndLocalDateGreaterThanEqualAndLocalDateLessThan(
                    motoboyId, startDate, endDate.plusDays(1));
        } else {
            List<String> motoboyIds = motoboyRepo.findByUsuarioId(user.getId()).stream()
                    .map(Motoboy::getId)
            ...
            gastos = motoboyIds.isEmpty()
                    ? List.of()
                    : gastoRepo.findByMotoboyIdInAndLocalDateGreaterThanEqualAndLocalDateLessThan(
